...
def upgrade():
    ...
    with op.batch_alter_table('option_categories', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_option_categories_created_at'), ['created_at'], unique=False)
    ...
    with op.batch_alter_table('option_values', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_option_values_is_active'), ['is_active'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('option_values', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_option_values_is_active'))
    ...
    with op.batch_alter_table('option_categories', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_option_categories_created_at'))
